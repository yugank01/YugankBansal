      ...
      <div>
        ...
        <div className="flex justify-center relative my-20 z-10">
          <div className="max-w-[89vw] md:max-w-2xl lg:max-w-[60vw] flex flex-col items-center justify-center">
            ...
            <p className="text-center md:tracking-wider my-4 text-sm md:text-lg lg:text-2xl text-white">
              Hi! I&apos;m{" "}
              <span className="text-blue-500 font-extrabold text-base md:text-xl lg:text-3xl">
                Yugank Bansal
              </span>
